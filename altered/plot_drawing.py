...
ratio1 = collections.deque([-6,7,0,-3,-6,-5,3,41,-1,-1],maxlen=10000)#collections.deque([26,26,28,30,32,30,30,26,32,22],maxlen=10000)#collections.deque(maxlen=10000)
...
x2, y2 = (0.61*5.5,0.61*20)#map(float, input('please input anchor2 position:').split())#input anchor2 Position
